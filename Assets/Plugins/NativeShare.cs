...
public static class NativeShare
{
    ...
    public static void Share(string body, bool chooser, string chooserText, string subject = null, string filePath = null, string url = null, string mimeType = "text/*")
    {
        ShareMultiple(body, chooser, chooserText, subject, filePath, url, mimeType);
    }
    ...
    /// <param name="url"></param>
    /// <param name="mimeType"></param>
    public static void ShareMultiple(string body, bool chooser, string chooserText, string subject = null, string filePaths = null, string url = null, string mimeType = "text/*")
    {
#if UNITY_ANDROID
        ShareAndroid(body, subject, url, filePaths, mimeType, chooser, chooserText);
#elif UNITY_IOS
		ShareIOS(body, subject, url, new string[] { filePaths });
#else
